...
def seed_partners(session):
    ...
    foundation_data = [
        ...
        ("Bill & Melinda Gates Foundation", "Health",     "Seattle",      "WA",  6.5,  2.0,
          8500000, 21000000, 12000000, 1.0, 8.5, 7.0, 4.0, 7.0,
          9.0, 8.0, 9.0, 7.0,  8,7,8,7,8,7,  "Active",     400,
          "Global health + equitable development; UVA Health + global studies alignment"),
        ("Robert Wood Johnson Foundation",  "Health",     "Princeton",    "NJ", 13.5,  0.5,
          5000000, 14000000,  8000000, 1.0, 7.0, 6.0, 5.0, 6.0,
          8.0, 7.0, 8.0, 8.0,  7,7,7,6,7,7,  "Active",     280,
          "Health equity and workforce; alignment with public health + nursing schools"),
        ...
        ("Alfred P. Sloan Foundation",      "Science",    "New York",     "NY",  2.4,  0.2,
          3500000,  9500000,  2000000, 0.0, 8.0, 5.0, 8.0, 6.0,
          8.0, 7.0, 7.0, 8.0,  7,6,7,7,8,6,  "Active",     200,
          "STEM research + fellowships; Sloan Fellows program active at UVA"),
        ...
        ("Gordon & Betty Moore Foundation", "Science",    "Palo Alto",    "CA",  9.0,  0.4,
          3000000,  8000000,  2000000, 0.0, 7.0, 5.0, 5.0, 5.0,
          7.0, 7.0, 7.0, 6.0,  7,6,7,6,7,5,  "Design",     160,
          "Environmental + biomedical science; environmental science faculty alignment"),
        ...
        ("Lumina Foundation",               "Education",  "Indianapolis", "IN",  1.6,  0.2,
          2000000,  5500000,  3000000, 0.0, 6.0, 5.0, 7.0, 5.0,
          8.0, 7.0, 7.0, 7.0,  7,7,7,6,7,7,  "Design",     150,
          "Higher ed access + completion; strong alignment with UVA access initiatives"),
        ...
        ("Carnegie Corporation of New York","Education",  "New York",     "NY",  3.8,  0.2,
          1500000,  4000000,  3000000, 0.0, 5.0, 4.0, 6.0, 5.0,
          7.0, 6.0, 7.0, 6.0,  6,6,7,5,6,6,  "Discovery",  110,
          "Democracy + education; Democracy Initiative and Curry School alignment"),
        ...
        ("Andrew W. Mellon Foundation",     "Arts",       "New York",     "NY",  7.5,  0.3,
          2000000,  5500000,  5000000, 0.0, 7.0, 5.0, 7.0, 6.0,
          7.0, 6.0, 7.0, 6.0,  6,6,7,6,7,7,  "Active",     170,
          "Humanities + arts; College of Arts & Sciences and McIntire alignment"),
    ]
