...
def seed_partners(session):
    partners_data = [
        ...
        #  sr5, sr_all, p5, proc_score, footprint, legal, talent, depth,
        #  fit, growth, access, feasibility,
        #  sp01, sp02, sp03, sp04, sp05, sp06,
        #  stage, est_k, notes)
        # proc_score: 0-10 holistic procurement value (scholarships + internships +
        #             sponsored research bundles + marketing/brand deals)
        ("Amazon",           "Tech",        "Seattle",       "WA", 525.0,  1600,
         4200000, 8100000, 1500000, 8.5, 12, 8, 22, 8.5,
         9.0, 8.0, 9.0, 7.5,  7,7,8,7,9,6,  "Active",     280, "AWS cloud research + internship pipeline"),
        ("Google",           "Tech",        "Mountain View", "CA", 282.0,  180,
         6800000, 14200000, 2800000, 8.0, 18, 12, 35, 9.0,
        ...
        ("Lockheed Martin",  "Defense",     "Bethesda",      "MD",  66.0,  116,
         9800000, 23000000, 600000, 7.0, 16, 18, 20, 8.8,
        ...
        ("Northrop Grumman", "Defense",     "Falls Church",  "VA",  39.0,   95,
         7100000, 16800000, 300000, 6.5, 11, 13, 14, 7.9,
        ...
        ("Dominion Energy",  "Energy",      "Richmond",      "VA",  14.0,   17,
          600000, 1800000, 2200000, 6.5,  3,  2,  6, 6.5,
